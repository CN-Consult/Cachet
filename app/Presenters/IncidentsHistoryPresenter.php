...
class IncidentsHistoryPresenter extends BasePresenter implements Arrayable
{
    use TimestampsTrait;
     ...
     * @return string
     */
    public function updated_at_diff()
    {
        return app(DateFactory::class)->make($this->wrappedObject->updated_at)->diffForHumans();
    }
     ...
     * @return string
     */
    public function updated_at_datetimepicker()
    {
        return app(DateFactory::class)->make($this->wrappedObject->updated_at)->format('d/m/Y H:i');
    }
